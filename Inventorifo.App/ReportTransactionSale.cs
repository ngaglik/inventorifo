...
namespace Inventorifo.App
{
    ...
    class ReportTransactionSale : Gtk.Box
    {
        ...
        public ReportTransactionSale(object parent, string mode, clTransaction filterTrans) : base(Orientation.Vertical, 3)
        {
            this.parent=parent;
        ...
        {            
            if(this.mode == "dialog"){
                ...
                if(selection.GetSelected( out iter)){
                    TransactionSaleReturn o = (TransactionSaleReturn)this.parent;                    
