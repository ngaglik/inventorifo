...
namespace Inventorifo.App
{
    ...
    class TransactionSale : Gtk.Box
    {
        ...
        {
            DataTable dtTransSelected = CoreCl.fillDtTransactionSale(transaction_id, btnDate.Label, "");
        ...
        public Response AddItem(){
            ...
            DataTable dts = CoreCl.fillDtProduct(2,new clStock{product_id=dtItemSelected.Rows[0].ItemArray[0].ToString()});
