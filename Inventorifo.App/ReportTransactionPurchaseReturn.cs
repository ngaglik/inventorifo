...
namespace Inventorifo.App
{
    ...
    class ReportTransactionPurchaseReturn : Gtk.Box
    {
        ...
        public ReportTransactionPurchaseReturn(object parent, string mode, clTransaction filterTrans) : base(Orientation.Vertical, 3)
        {
            this.parent=parent;
            ...
            lbTitle.Text = "Report Purchase Return";
