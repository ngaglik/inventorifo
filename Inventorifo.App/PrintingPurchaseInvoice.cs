...
{
    public class PrintingPurchaseInvoice
    {
        ...
        DataTable dtTrans;
        DataTable dtItems;
        TransactionPurchase parent;

        public PrintingPurchaseInvoice(object parent, DataTable dtTrans, DataTable dtItems)
        {
            this.parent=(TransactionPurchase)parent;
